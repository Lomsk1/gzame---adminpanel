...
export const ChatRoomList: React.FC<ChatRoomListProps> = ({ rooms = [], activeRoom, onSelectRoom, onCreateRoom }) => {
    ...
    return (
        <div className="flex-1 min-h-0 flex flex-col overflow-hidden border-r border-admin-border/30 bg-black p-0">
            {/* Terminal Header */}
            <div className="p-4 border-b border-admin-border/20 bg-admin-primary/5">
                <div className="flex items-center justify-between">
                    <h3 className="text-sm font-bold text-admin-primary uppercase tracking-[0.4em] flex items-center gap-2">
                        ...
                        >
                            <div className="p-3 border-y border-r border-admin-border/10 group-hover:border-admin-border/30">
                                <div className="flex justify-between items-start mb-1">
                                    <span className={`text-base font-bold tracking-tighter uppercase ${isActive ? "text-admin-primary" : "text-gray-400"}`}>
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-sm text-admin-text-muted lowercase font-mono italic opacity-60">
            ...
            <button
                ...
                className="m-4 border border-dashed border-admin-primary/30 p-3 text-sm cursor-pointer text-admin-primary hover:bg-admin-primary/10 transition-all uppercase tracking-widest"
            >
