...
export default function MainSidebar() {
    const navGroups = [
        ...
        { label: "Operations", links: [{ to: "/quests", label: "Quest Templates" }, { to: "/daily-quests", label: "Daily Quests" }, { to: "/rooms", label: "Chat Rooms" }, { to: "/specialists", label: "Specialists" }, { to: "/specialists/booking-clicks", label: "Booking Clicks" }, { to: "/early-access", label: "Early access" }] },
    ];
