...
export const TopOperatorsCard = ({ users }: { users: StatsUserTypes["data"]["topUsers"] }) => {
    ...
    return (
        <GlassCard className="h-full border-admin-accent/20">
            <h3 className="text-[10px] font-black uppercase tracking-[0.2em] text-admin-accent mb-4">
                    ...
                    >
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex flex-col">
                                ...
                                <span className="text-[8px] uppercase text-admin-text-dim">
                                    {t("common.levelShort", { level: user.currentLevel })}
                                </span>
                            </div>
                        </div>
                        <div className="text-right">
                            <div className="text-[10px] font-black text-admin-warning">
                                {user.currentStreakDays}
                                {t("common.daysSuffix").toUpperCase()}
                            </div>
                            <div className="text-[7px] text-admin-text-dim uppercase tracking-tighter">
                                {t("common.streak")}
                            </div>
                        </div>
                    </div>
