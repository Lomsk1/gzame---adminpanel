...
export default function QuestionsManagementPage() {
    ...
    if (fetcher.state === "idle" && fetcher.data) {
        ...
        if (success) {
            toast.success(message || t("questions.toast.success"), { id: toastId });
        } else {
            toast.error(t("questions.toast.failure"), { description: error, id: toastId });
        }
        fetcher.reset();
    }
                                    ...
                                    >
                                        <div className="flex flex-col lg:flex-row items-stretch">
                                            ...
                                            <div className="flex lg:flex-col border-t lg:border-t-0 lg:border-l border-admin-border min-w-35">
                                                ...
                                                <AdminConfirmWrapper
                                                    title={t("questions.purgeTitle", { seq: q.sequence })}
                                                    description={t("questions.purgeDesc")}
