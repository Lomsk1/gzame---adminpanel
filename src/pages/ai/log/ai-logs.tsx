                        ...
                        {selectedLog ? (
                            <div className="space-y-6 animate-in slide-in-from-right-4 duration-300">
                                <GlassCard glow hoverable className="border-admin-primary/20">
                                    <h3 className="text-xs font-black text-admin-primary uppercase tracking-[0.2em] mb-4">{t("aiLogs.decisionPath")}</h3>

                                    <div className="space-y-4">
                                        <div className="p-3 bg-admin-bg/50 rounded-lg border border-admin-border">
                                            <p className="text-[10px] text-admin-text-dim uppercase font-bold mb-1">{t("aiLogs.reasoningArchitecture")}</p>
                                        ...
                                        <div className="grid grid-cols-2 gap-3">
                                            <div className="p-3 bg-admin-bg/50 rounded-lg border border-admin-border">
                                                <p className="text-[10px] text-admin-text-dim uppercase font-bold mb-1">{t("aiLogs.combinedClass")}</p>
                                            ...
                                            <div className="p-3 bg-admin-bg/50 rounded-lg border border-admin-border">
                                                <p className="text-[10px] text-admin-text-dim uppercase font-bold mb-1">{t("aiLogs.subType")}</p>
                            ...
                            <div className="h-64 flex flex-col items-center justify-center border-2 border-dashed border-admin-border rounded-2xl text-admin-text-dim">
                                ...
                                <p className="text-[10px] uppercase tracking-widest font-bold">{t("aiLogs.selectLog")}</p>
                            </div>
                        )}
                    </div>
                </div>
